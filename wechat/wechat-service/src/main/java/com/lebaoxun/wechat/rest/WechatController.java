...
public class WechatController {
	...
	ResponseMessage getOuath2Url(@RequestParam(value="kindOf") String kindOf,
		...
		return new ResponseMessage(String.format(url, woaconfig.getApp_id(),redirect_uri,state));
	}
