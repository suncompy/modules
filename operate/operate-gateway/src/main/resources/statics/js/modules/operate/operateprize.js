$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'operate/operateprize/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.operatePrize.id == null ? "operate/operateprize/save" : "operate/operateprize/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "operate/operateprize/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "operate/operateprize/info/"+id, function(r){
