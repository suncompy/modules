$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'operate/operateprizegetlog/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.operatePrizeGetLog.id == null ? "operate/operateprizegetlog/save" : "operate/operateprizegetlog/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "operate/operateprizegetlog/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "operate/operateprizegetlog/info/"+id, function(r){
