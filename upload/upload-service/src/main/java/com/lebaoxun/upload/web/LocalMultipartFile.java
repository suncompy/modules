package com.lebaoxun.upload.web;
...
public class LocalMultipartFile implements MultipartFile {
	 ...
	 */
	public LocalMultipartFile(String name, byte[] content) {
	 ...
	 */
	public LocalMultipartFile(String name, InputStream contentStream) throws IOException {
	 ...
	 * @throws IOException if reading from the stream failed
	 */
	public LocalMultipartFile(String name, String originalFilename, String contentType, InputStream contentStream)
			throws IOException {
